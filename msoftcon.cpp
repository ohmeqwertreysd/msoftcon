...
void init_graphics()
{
	...
	hConsole = CreateFile("CONOUT$", GENERIC_WRITE | GENERIC_READ,   // "CONOUT$" не читается из-за включеного юникода 4Otchet->Свойства->Свойства конфигурации->Общие->Набор символов->Не задано
...
void draw_rectangle(int left, int top, int right, int bottom)
{
	...
	int j = 0;
	for (j; j < width; j++)      //string of squares
		temp[j] = fill_char;
	temp[j] = 0;                    //null
